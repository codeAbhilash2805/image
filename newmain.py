#Model Summary
"""
Consists of VGG-16 architecture without last(SOFTMAX) layer connected to three GRU layers(Decoder). 
The input to the VGG-16 are preprocessed images of shape (224,224)

The output of the VGG-16 is (None,4096)

which is fed to the decoder along with captions
...
def batch_generator(batch_size):
    ...
    while True:
        ...
        tokens = [captions_marked_list[_] for _ in idx]
...
if __name__ == "__main__"":
    ...
    captions_marked =  mark_captions(descriptions)
    ...
    capsintencoded = word2int(caps_markedwords)
    ...
    transfer_values = np.array(trans_values).reshape(num_images,4096)
